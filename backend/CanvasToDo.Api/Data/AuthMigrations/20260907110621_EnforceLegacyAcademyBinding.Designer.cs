...
namespace CanvasToDo.Api.Data.AuthMigrations
{
    ...
    [Migration("20260907110621_EnforceLegacyAcademyBinding")]
    partial class EnforceLegacyAcademyBinding
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CanvasToDo.Api.Domain.Identity.ApplicationUser", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<System.Guid>", b =>
                {
                    b.HasOne("CanvasToDo.Api.Domain.Identity.ApplicationUser", null)
                        .WithMany()
